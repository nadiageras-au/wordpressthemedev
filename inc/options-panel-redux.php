<?php
    ...
    // Первым делом создать переменную для настроект
    ...
    $args = array(
        ...
        'menu_title'           => __( 'Wayup Options', 'redux-framework-demo' ),
        'page_title'           => __( 'Wayup Super Options', 'redux-framework-demo' ),
    ...
    $args['share_icons'][] = array(
        'url'   => 'https://www.facebook.com/alexandr.sochirca',
        'title' => 'Лайкате меня',
        'icon'  => 'el el-facebook'
    );

    $args['share_icons'][] = array(
        'url'   => 'https://www.vk.com/alexandr.sochirca',
        'title' => 'Лайкате меня',
    ...
    $args['footer_text'] = wp_kses( __('<p>Спасибо. Это конец</p>','wayup'), array('p'=> array()) );
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            array(
                ...
                'type'     => 'media',
                'url'      => true,
                'title'    => __( 'Background for Home Header', 'redux-framework-demo' ),
                'compiler' => 'true',
                'desc'     => __( 'Recommended size 1920x-998px', 'redux-framework-demo' ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'subsection'       => true,
        'customizer_width' => '450px',
        'desc'             => esc_html__( 'Data for Service Page', 'wayup' ),
        'fields'           => array(
