...
if (!function_exists('wayup')) {
    function wayup( $atts, $content = null ) {
        ...
        return '<h1>' . do_shortcode($content) . '</h1><br>' . $title;
    }
...
if (!function_exists('ale_map')) {
            ...
            <script type="text/javascript">
                ...
                function ale_run_map_<?php echo $map_id ; ?>(){
                    ...
                    var marker = new google.maps.Marker({
                        ...
                        icon: 'http://localhost/wordpress/wp-content/uploads/2018/12/iconfinder_resolutions-21_897231.png'
                    });
                }
    ...
    function ale_map_load_scripts() {
        wp_register_script( 'google-maps-api', 'http://maps.google.com/maps/api/js?key=AIzaSyCyy-sYVmabOg78HupUX2oQpl5mkZZfddA&v=3.34' );
    }
    ...
    function ale_map_get_coordinates( $address, $force_refresh = false ) {
        ...
        if ($force_refresh || $coordinates === false) {
            ...
            $args       = array( 'address' => urlencode( $address ), 'sensor' => 'false', 'key' => 'AIzaSyCyy-sYVmabOg78HupUX2oQpl5mkZZfddA' );
