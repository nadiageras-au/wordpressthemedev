                ...
                <div class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?> cart__row">
                    ...
                    <div class="cart__block cart__block_first">
                        ...
                        if ( ! $product_permalink ) {
                            ...
                            printf( '<a href="%s" class="cart__image">%s</a>', esc_url( $product_permalink ), wp_kses_post( $thumbnail ) );
                        }
                        ?>
            ...
            <div class="promo">
                    <div class="coupon">
                        <?php if ( wc_coupons_enabled() ) { ?>
                            <input type="text" name="coupon_code" class="input-text promo__input log__input" id="coupon_code" value="" placeholder="Код купона" /> <button type="submit" class="button bnt_woo promo__btn" name="apply_coupon" value="Применить купон">Применить купон</button>
                            <?php do_action( 'woocommerce_cart_coupon' ); ?>
                        <?php } ?>
                        &nbsp; &nbsp; &nbsp;
                        <button type="submit" class="button bnt_woo promo__btn" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>"><?php esc_html_e( 'Update cart', 'woocommerce' ); ?></button>
